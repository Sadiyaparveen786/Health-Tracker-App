  ...
  template: `
    <div class="container">
      ...
      <form #workoutForm="ngForm" (ngSubmit)="onSubmit(workoutForm)">
        ...
        <div class="form-row">
          <div class="form-group">
            <label for="workoutType">Workout specification*</label>
          ...
          <div class="form-group">
            <label for="workoutMinutes">Workout Time(in minutes)*</label>
            <input type="number" id="workoutMinutes" name="workoutMinutes" [(ngModel)]="workoutMinutes" required>
          </div>
        </div>
        <button type="submit" [disabled]="!workoutForm.form.valid">Submit</button>
      </form>
...
export class AppComponent implements OnInit {
  ...
  availableWorkoutTypes: string[] = [
    'Aerobic excercise', 'Walking', 'Cycling', 'Swimming', 'Stretching',
    'Squat jump', 'Pushups', 'Elliptical', 'Dance', 'Martial Arts'
  ];
  ...
  loadFromLocalStorage() {
    ...
    if (storedData) {
      ...
      this.workoutEntries = [
        { userName: 'Nina william', workoutType: 'Stretching', workoutMinutes: 35 },
        { userName: 'Adelina David', workoutType: 'Squat jump', workoutMinutes: 25 },
        { userName: 'John Dev', workoutType: 'Dance', workoutMinutes: 50 },
        { userName: 'Diego', workoutType: 'Pushups', workoutMinutes: 30 },
        { userName: 'Alexie David', workoutType: 'Elliptical', workoutMinutes: 40 },
        { userName: 'Sunny', workoutType: 'Walking', workoutMinutes: 30 }
      ];
